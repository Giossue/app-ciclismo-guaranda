...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            role="group"
            className={cn(
                'group/input-group relative flex min-h-11 w-full min-w-0 items-center rounded-[var(--radius-control)] border border-input bg-input shadow-xs transition-[color,box-shadow] outline-none has-[>textarea]:h-auto',
