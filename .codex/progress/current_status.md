...
- La bandeja se separa por rol: ciclistas usan `/notifications`; administradores usan `/admin/notifications` y sus mutaciones homólogas protegidas por middleware `admin`. No se duplica `notificaciones_app`: el aislamiento se mantiene por `user_id`.
