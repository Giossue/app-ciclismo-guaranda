...
return [
    ...
    'assistant' => [
        'openai' => [
            ...
            'embedding_model' => env('GUARANDA_GO_OPENAI_EMBEDDING_MODEL', 'text-embedding-3-large'),
            'embedding_dimensions' => (int) env('GUARANDA_GO_OPENAI_EMBEDDING_DIMENSIONS', 3072),
            'embedding_batch_size' => (int) env('GUARANDA_GO_OPENAI_EMBEDDING_BATCH_SIZE', 50),
